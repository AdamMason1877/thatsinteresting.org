export const disciplineMeta = {
  network: {
    ...
    readerQuestion: 'Can everything still reach the right destination while paths and conditions change?',
    readerTakeaway: 'Network difficulty grows when more devices and organizations must agree on a route without sharing one complete view.',
  ...
  computer: {
    ...
    readerQuestion: 'Does the system still do exactly what its abstractions promise?',
    readerTakeaway: 'Computer-science difficulty grows when correctness depends on exact ordering, semantics, or proof across many possible states.',
  ...
  security: {
    ...
    readerQuestion: 'Can those promises survive stolen authority, misuse, and an active attacker?',
    readerTakeaway: 'Security difficulty grows when the whole system must preserve trust while an opponent deliberately searches for its weakest seam.',
...
export const conceptAudit = {
  'NET-01': {
    plain: 'The internet has no single traffic controller, so thousands of networks must reach a stable answer from local rules.',
  ...
  'NET-02': {
    plain: 'Two networks must agree at once: the physical underlay that carries traffic and the virtual overlay that gives it meaning.',
  ...
  'NET-03': {
    plain: 'The system must choose a useful path while the map, available capacity, and failure conditions keep changing.',
  ...
  'NET-04': {
    plain: 'One service path crosses several providers, and the hardest failure may live beyond the dashboard or team you control.',
  ...
  'NET-05': {
    plain: 'Automation can turn one mistaken idea into thousands of perfectly executed changes before a person sees the first symptom.',
  ...
  'NET-06': {
    plain: 'The old and new versions of the internet must coexist for years without leaving applications, monitoring, or security behind.',
  ...
  'CS-01': {
    plain: 'Machines must agree on one durable order even though delay makes a slow machine look exactly like a failed one.',
  ...
  'CS-02': {
    plain: 'Correctness must survive many possible operation orders—including rare combinations that disappear when observed.',
  ...
  'CS-03': {
    plain: 'One privileged layer coordinates nearly every processor, memory, storage, device, and application resource.',
  ...
  'CS-04': {
    plain: 'A simple transaction hides difficult promises about what every user may observe during concurrency and failure.',
  ...
  'CS-05': {
    plain: 'A compiler must radically transform a program without changing what that program is supposed to mean.',
  ...
  'CS-06': {
    plain: 'A proof can be exact and still miss reality if the model leaves out an important behavior or assumption.',
  ...
  'SEC-01': {
    plain: 'Strong mathematics can still fail through weak randomness, implementation mistakes, or mishandled keys.',
  ...
  'SEC-02': {
    plain: 'A successful login does not guarantee that the resulting authority is current, appropriate, or safely delegated.',
  ...
  'SEC-03': {
    plain: 'Every access decision depends on fresh identity, device, workload, network, and threat information from several systems.',
  ...
  'SEC-04': {
    plain: 'Trust must survive every handoff from source code and dependencies through build systems, delivery, and runtime.',
  ...
  'SEC-05': {
    plain: 'Investigators must build a reliable story from incomplete evidence while the system and the attacker keep changing it.',
  ...
  'SEC-06': {
    plain: 'The permission written in one policy is not always the permission that emerges after every rule and delegation combines.',
