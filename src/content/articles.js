...
export const articles = [
  defineArticle({
    ...
    dek: 'The deepest abstractions live in computer science. The widest live coordination belongs to networks. Security inherits both—and adds an opponent.',
    body: [
      {
        label: '01 · The map',
    ...
    sources: [
      ...
      { label: 'ACM, IEEE-CS & AAAI · Computer Science Curricula 2023', url: 'https://csed.acm.org/final-report/' },
    ...
    methodology: {
      title: 'This ranks problem shapes, not people.',
      copy: 'Scores estimate five properties of the concept at production scale: conceptual depth, integration span, dynamic state, failure opacity, and adversarial pressure. They are comparative editorial judgments informed by the cited standards and literature, rounded to avoid pretending that complexity is directly measurable. A small team can face a harder instance than a global one; mature tooling can compress difficulty; and the same concept changes radically with scale, regulation, legacy constraints, and threat model.',
    },
  }),
  defineArticle({
