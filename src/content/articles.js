...
export const articles = [
  defineArticle({
    ...
    poster_frame: '',
    cover_image: '/media/exhibit-covers/complexity-junction.webp',
    cover_alt: 'Cyan network paths, green computational blocks, and violet security layers converge at one illuminated junction.',
    cover_caption: 'Paths × state × trust',
    mobile_video: '',
...
No people. No campuses. No classrooms. No diplomas. No money imagery. No stock footage. No icons. No logos. No legible typography. No generated labels. No decorative sci-fi interface.`,
    ...
    cover_image: '/media/exhibit-covers/rigor-reward.webp',
    cover_alt: 'Three stairways of different difficulty rise toward outcomes whose heights do not consistently match the effort required.',
    cover_caption: 'Difficulty changes the odds, not the outcome',
